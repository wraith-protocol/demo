...
export const faqEntries: FAQEntry[] = [
  // Getting started
  {
    ...
    answer:
      "A stealth address is a one-time payment destination that hides the recipient's identity on the blockchain. When someone sends funds to a stealth address, only the recipient can detect and spend the funds, even though the transaction is publicly visible. This is achieved through cryptographic techniques that allow the recipient to scan the blockchain for payments meant for them without revealing their public address to the sender.",
  ...
  },
  {
    ...
    answer:
      "Message signing proves ownership of your wallet without exposing your private key. When you sign a message in the Wraith demo, you're authorizing the application to generate stealth addresses on your behalf. This is a standard security practice in Web3 that allows dApps to interact with your wallet safely. The signature doesn't give the app access to your funds or allow it to sign transactions.",
  ...
  },
  {
    ...
    answer:
      'The Wraith demo client runs entirely in your browser and does not send transaction data to any backend server. All cryptographic operations happen locally on your device. However, the Stellar network itself is public, so anyone (including the Wraith Protocol team) could theoretically analyze the blockchain. The demo specifically does not log or store any information about your transactions.',
  ...
  },
  {
    ...
    answer:
      "If your wallet won't connect, try these steps: 1) Ensure you're using a supported browser (Chrome, Firefox, Brave, or Edge), 2) Check that your wallet extension is enabled and unlocked, 3) Refresh the page and try connecting again, 4) If using Freighter, make sure you're on the latest version. For Albedo, ensure pop-ups are allowed in your browser settings. If issues persist, try a different wallet to isolate the problem.",
